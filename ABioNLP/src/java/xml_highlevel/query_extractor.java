...
public class query_extractor {
    ...
    public query retr_papers(String qry,int no_to_retr)
    {
        ...
        try{
            String base_url="https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax="+query_var.no_retrieved_results+"&term=";
            base_url+=qry;
    ...
    public query retr_papers(query query_var,int no_of_papers)
    {
        try{
            ...
            String base_url="https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retstart="+query_var.no_retrieved_results+"&retmax="+no_of_papers+"&term="+query_var.query_name;
